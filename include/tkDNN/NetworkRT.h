...
public:
    ...
    NetworkRT(Network *net, const char *name, const std::string& encryption_key="");
    virtual ~NetworkRT();
    ...
    */
    ...
    bool serialize(const char *filename, const std::string& encryption_key="");
#else
    bool serialize(const char *filename,nvinfer1::IHostMemory *ptr, const std::string& encryption_key="");
#endif

    bool deserialize(const char *filename, const std::string& encryption_key="");
    void destroy();
