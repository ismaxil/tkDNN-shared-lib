...
public:
    ...
    bool init(const std::string& tensor_path, const std::string& encryption_key, const int n_classes=80, const int n_batches=1, const float conf_thresh=0.3);
